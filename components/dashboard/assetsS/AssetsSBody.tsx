    ...
    <>
      ...
      {[
        ...
        <div key={index} className="flex flex-row xl:flex-col max-xl:flex-wrap max-xl:relative max-xl:mb-[9px] max-xl:border-t-2 max-xl:border-[#FFDDF7]">
          ...
          <div className="max-xl:w-1/2 border-2 border-solid border-[#FFDDF7] border-t-0 max-xl:border-l-0 flex gap-10 max-xl:gap-8 items-center py-6 max-xl:px-10 max-xs:gap-[2rem] max-sm:gap-[2.1rem] px-4 max-xl:flex-col max-xl:pb-[10rem] max-xl:items-end">

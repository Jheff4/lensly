...
const SupplyHead = () => {
  return (
    <div className="shrink-0 border-2 border-solid border-[#FFDDF7] border-t-0 max-lg:border-r-0 flex gap-12 max-lg:gap-14 items-center bg-white py-8 px-6 max-lg:flex-col max-lg:h-full">

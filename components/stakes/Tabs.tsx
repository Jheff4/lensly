...
const Tabs = () => {
  return (
    <div className='flex gap-7 max-sm:gap-5 max-ssm:flex-wrap justify-center'>
      <div className='flex flex-col items-start p-6 max-sm:p-5 max-lg:max-w-fit tabs-border text-white -ml-2'>
      ...
      <div className='flex flex-col justify-center items-start p-6 max-sm:p-5 tabs-border text-white max-md:max-w-fit -ml-2'>

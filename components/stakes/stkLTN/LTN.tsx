  ...
  return (     
    <div className="flex flex-row justify-between rounded-lg border-2 border-solid border-[#FFDDF7] mt-8 max-lg:mt-0 mb-8 max-xl:mb-6 max-lg:mb-2 py-[1.7rem] px-4 items-center max-xl:flex-col max-xl:gap-9">
      <div className="flex flex-row gap-6 items-center justify-between">
        <span className="text-gondola text-base font-semibold flex gap-1 xl:w-[3rem] bg-white max-xl:text-xl">
          <Image 
            src="/LTN.svg"
            alt="LTN"
            width={25}
        ...
        <span className='flex items-center px-7 py-1.5 rounded-[100px] text-white text-[10px] font-semibold bg-razzmatazz lg:hidden'>
          GET LNT TOKEN
        </span>
      </div>

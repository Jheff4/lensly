    ...
    <>
      ...
      {[
        ...
        <div key={index} className="flex flex-row lg:flex-col max-lg:flex-wrap max-lg:relative max-lg:mb-[9px] max-lg:border-t-2 max-lg:border-[#FFDDF7]">
          ...
          <div className="max-lg:w-1/2 border-2 border-solid border-[#FFDDF7] border-t-0 max-lg:border-l-0 max-xxx:gap-[2.65rem] max-xxs:gap-[2.7rem] max-xsm:gap-[2.4rem] max-xs:gap-[2.4rem] max-sm:gap-[2.45rem] flex gap-12 max-md:gap-[2.35rem] lg:gap-[5rem] max-lg:gap-[2.2rem] items-center py-6 max-lg:px-10 px-4 max-lg:flex-col max-lg:pb-[8rem] max-lg:items-end">

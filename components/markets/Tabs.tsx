...
const Tabs = () => {
  return (
    <div className='flex gap-6 max-md:flex max-md:gap-4 max-md:flex-wrap max-xsm:gap-2'>
      <div className='flex flex-col justify-center items-start rounded-lg p-6 bg-greenHaze text-white w-[11.87rem] max-md:max-w-fit max-md:tracking-wider max-md:p-4 max-md:order-2 max-lg:justify-self-end'>
      ...
      <div className='flex flex-col items-start rounded-lg p-6 max-lg:max-w-fit bg-treePoppy-100 text-gondola max-md:p-4 m max-md:order-1'>
      ...
      <div className='flex flex-col justify-center items-start rounded-lg p-6 bg-cardinalPink-100 text-white w-fit max-md:p-4 max-md:order-3 max-lg:justify-self-end'>

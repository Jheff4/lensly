...
const Info = () => {
  return (
    <div>
      <div>
        <h1 className='text-gondola text-2xl font-medium mb-8'>Your info</h1>
        <div className='inline-flex justify-center items-center border px-4 py-2 rounded-[100px] border-solid border-[#FFDDF7] text-gondola text-base font-bold mb-4'>
          Tenet23ec7...bac9
        </div>
      ...
      <div>
        <h1 className='text-gondola text-2xl font-medium mt-16'>Delegated power</h1>
        <p className='text-[#919191] mt-4 text-sm font-semibold'>
        ...
        <Button className='max-w-[18rem] mt-8 flex w-full justify-center items-center gap-2.5 p-4 rounded-[100px] text-white text-base font-bold'>
          Set up delegation
        </Button>
      </div>
    </div>
